...
from .models import Event,Fighter,Club,Registration
...
def home(request):
    ...
    return render(request,"index.html",{"events":eventData,"fighter":fighterData,"photos":all_files,"club":clubData})
